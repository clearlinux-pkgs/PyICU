...
Source0  : https://files.pythonhosted.org/packages/57/b2/66a58057a537527d7307576f2d32f239cc411b911401276d6922caa94755/PyICU-2.4.3.tar.gz
...
%prep
%setup -q -n PyICU-2.4.3
cd %{_builddir}/PyICU-2.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588305979
...
cp %{_builddir}/PyICU-2.4.3/LICENSE %{buildroot}/usr/share/package-licenses/PyICU/30410e52eb79243849038655af921b51845dfed4
